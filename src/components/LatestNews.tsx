...
/**
 * Institutions grid + slogan banner + mission block.
 * Institutions come from the Partners collection (type: Authority &
 * Regulatory); all copy comes from Homepage → Sections.
 */
export type LatestNewsProps = {
  ...
  institutions: { name: string; role?: string | null; description?: string | null }[];
  banner: {
    chip?: string | null;
    line1?: string | null;
    line2?: string | null;
          ...
          <div className="mb-20">
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <h2 className="text-4xl sm:text-5xl font-light text-ras-charcoal tracking-tightest leading-tight">
                {institutionsHeading} <br />
                <span className="font-semibold">{institutionsHeadingBold}</span>
              </h2>
            </div>
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl space-y-6">
              ...
              <h2 className="text-3xl sm:text-5xl md:text-6xl font-light tracking-tightest leading-none text-white">
                {banner.line1}<br />
                <span className="font-bold text-ras-gold">{banner.line2}</span>
              </h2>
