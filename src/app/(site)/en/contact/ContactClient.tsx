                        ...
                        <div className="mt-1 space-y-1">
                          {phones.map((p) => (
                            <p key={p.number} className="text-sm font-semibold text-ras-charcoal">
                              {p.label ? `${p.label}: ` : ""}
                              <a href={`tel:${p.number.replace(/[^+\d]/g, "")}`} className="hover:text-ras-gold transition-colors">{p.number}</a>
                            </p>
                          ))}
                        </div>
                      </div>
                        ...
                        <div className="mt-1 space-y-1">
                          {emails.map((m) => (
                            <p key={m.email} className="text-sm font-semibold text-ras-charcoal">
                              {m.label ? `${m.label}: ` : ""}
                              <a href={`mailto:${m.email}`} className="hover:text-ras-gold transition-colors">{m.email}</a>
                            </p>
                          ))}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-sm text-ras-charcoal mt-1 font-semibold">
                          ...
                          {restHours.map((h) => (
                            <span key={h.days}>
                              <br />
                              <span className="text-ras-gold text-xs">{h.days}: {h.hours}</span>
                            </span>
                          ))}
                        </p>
                      </div>
                          ...
                          {departments.map((d) => (
                            <p key={d.name} className="text-sm font-semibold text-ras-charcoal">
                              ...
                              {d.email && (
                                <>
                                  {": "}
                                  <a href={`mailto:${d.email}`} className="hover:text-ras-gold transition-colors">{d.email}</a>
                                </>
                              )}
