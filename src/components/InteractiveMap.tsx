...
export default function InteractiveMap({
  ...
  const getPathClasses = (id: string) => {
    ...
    const hovered = hoveredEmirate === getEmirateName(id);
    
    let baseClasses = "transition-all duration-500 cursor-pointer origin-center ";
    
    if (active) {
      baseClasses += "fill-ras-gold/25 stroke-ras-gold/80 opacity-100 ";
      if (hovered) {
        baseClasses += "fill-ras-gold/45 stroke-ras-goldDark/100 scale-[1.002] filter drop-shadow-[0_0_12px_rgba(197,168,128,0.6)]";
      } else {
        baseClasses += "filter drop-shadow-[0_0_6px_rgba(197,168,128,0.35)] hover:fill-ras-gold/35";
      }
    } else {
      baseClasses += "fill-ras-grey/5 stroke-ras-grey/15 opacity-25 ";
      if (hovered) {
        baseClasses += "fill-ras-grey/10 stroke-ras-grey/30 opacity-45";
      }
    }
  ...
  return (
    <section id="uae-footprint" className="py-24 sm:py-32 bg-[#F7F4EF] relative overflow-hidden border-t border-ras-grey/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6 sm:space-y-8">
            <div className="space-y-3">
              <span className="text-ras-goldInk text-xs font-bold uppercase tracking-widest block">
                {chip}
              </span>
              <h2 className="text-5xl sm:text-6xl lg:text-7xl font-extralight text-ras-charcoal tracking-tightest leading-none flex flex-col">
                ...
                <span className="text-ras-grey font-light">{headingBottom}</span>
              </h2>
            </div>
          ...
          <div className="lg:col-span-7 flex flex-col items-center w-full">
            ...
            {/* SVG Map Container (Borderless and flat on background) */}
            <div className="relative w-full aspect-[760/613] min-h-[300px]">
          
          {/* High-Fidelity UAE Vector Map */}
          <div className="absolute inset-0 z-0 flex items-center justify-center p-4">
            <svg 
              className="w-full h-full text-ras-greyOnDark fill-current" 
              viewBox="0 0 760 613" 
              xmlns="http://www.w3.org/2000/svg"
              aria-label="High Fidelity Map of UAE"
            >
              {/* Abu Dhabi */}
              <path
                id="abu-dhabi"
            ...
            {hoveredProject && (
              ...
              >
                ...
                <div className="flex-grow space-y-1">
                  ...
                  <div className="pt-2 flex justify-between items-center text-[10px] uppercase font-bold tracking-widest text-ras-gold">
                    <span>CAPACITY / SECTOR</span>
                    <span className="bg-white/10 px-2 py-0.5 rounded-full border border-white/5">
                      {hoveredProject.capacity}
                    </span>
                  </div>
                </div>
              </motion.div>
